...
/**
 * REST controller for managing {@link fr.ippon.kompetitors.domain.Clients}.
 */
@RestController
@RequestMapping("/api")
public class ClientsResource {
     ...
     */
    @GetMapping("/clients")
    public List<Clients> getAllClients(@RequestParam(required = false) Long competitorId) {
        log.debug("REST request to get all Clients");
        if (competitorId != null) {
            return clientsRepository.findByCompetitorId(competitorId);
        }
