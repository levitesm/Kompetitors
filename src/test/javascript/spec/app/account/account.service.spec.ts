...
describe('Account Service test suite', () => {
  ...
  it('should init service and do not retrieve account', async () => {
    ...
    accountService = await new AccountService(store, new TranslationService(store, i18n, cookie), cookie, router);
  ...
  it('should init service and retrieve account if already logged in before but no account found', async () => {
    ...
    accountService = await new AccountService(store, new TranslationService(store, i18n, mockedCookie), mockedCookie, router);
