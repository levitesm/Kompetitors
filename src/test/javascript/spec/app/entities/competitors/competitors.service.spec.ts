...
describe('Service Tests', () => {
  describe('Competitors Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Competitors(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Competitors', async () => {
      ...
      it('should update a Competitors', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            webSite: 'BBBBBB',
      ...
      it('should delete a Competitors', async () => {
